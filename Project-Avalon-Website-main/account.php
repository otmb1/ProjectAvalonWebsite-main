...
<html lang="en">
	...
	<body>
		...
		<!-- Section that displays user's profile information and account options -->
		<div class="container-fluid bg-3 text-center">
			<h1 class="margin"><strong>MY PROFILE</strong></h1>
			  <div class="account-content">
				<div class="jumbotron">
					<h4><strong>Username: <?php echo $_SESSION['Username']; ?></strong></h4>
					<h4><strong>Email Address: <?php echo $_SESSION['Email']; ?></strong></h4>
					<h4><strong>Phone Number: <?php echo $_SESSION['PNumber']; ?></strong></h4>
					<?php
						$sql = "SELECT Created FROM Users where UUID = '$userID'";
						$result = mysqli_query($connect,$sql);
						while($row = mysqli_fetch_assoc($result))
						{
					?>
					<h4 style="margin-top: 50px;"><strong>Account Created: <?php echo $row['Created']; ?></strong></h4>
					<?php } ?>
				
			<a href="updatedetails.php" class="btn btn-default btn-lg" style="margin-top: 50px;">
				<span class="bi bi-pencil-square"></span> Update Details
			</a>
			<br>
			<a href="updatepassword.php" class="btn btn-default btn-lg" style="margin-top: 20px;">
				<span class="bi bi-pencil-square"></span> Update Password
			</a>
			<br></br>
			<br></br>
			<a href="inventory.php" class="btn btn-default btn-lg" style="margin-top: 20px;">
				<span class="bi bi-box-seam"></span> Inventory List
			</a>
			<br>
			<a href="statistics.php" class="btn btn-default btn-lg" style="margin-top: 20px;">
				<span class="bi bi-list-ol"></span> My Statistics
			</a>
			</div>
			  </div>
