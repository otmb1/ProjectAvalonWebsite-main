...
if(isset($_SESSION["Username"])) {
    header("Location: hubcommunity.php");
}
	...
	<body>
		...
		<div class="container-fluid bg-2 text-center">
			...
			<div class="index-content">
					...
					<div class="col-lg-6">
						<div class="card-hub">
							<a href="community.php"><img src="pictures/Blog1.png" alt="Image" style="width: 300px; height: auto;"></a>
							<h4>BLOG</h4>
							<p>Our blog allows you to receive regular updates and news in regard to the developments of our game.</p>
							<a href="community.php" class="blog-button">Enter</a>
						</div>
					</div>
				</a>
			</div>
