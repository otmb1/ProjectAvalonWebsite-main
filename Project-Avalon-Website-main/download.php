...
<html lang="en">
	...
	<body>
		...
		<div class="container-fluid bg-3 text-center">
			...
			<a class="btn btn-default btn-lg" style="margin-top: 50px;" href="./download/LOA.zip" download>
				<span class="bi bi-download"></span> Download (.zip)
			</a>
			<h4 style="margin-top: 50px;"><strong><i>HOW TO INSTALL LEGENDS OF AVALON: <br></br> 1) Download Game Folder <br> 2) Extract .zip folder using an archiving tool program (e.g. WinRAR, 7Zip, etc.) <br> 3) Ready to play by launching the LegendsOfAvalon.exe file! </i><br></br> LET THE BATTLE COMMENCE!!</strong></h4>
