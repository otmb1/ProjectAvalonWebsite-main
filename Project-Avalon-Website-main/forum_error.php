...
// if statement that redirects user to the forum page if user is signed in
...
<html lang="en">
	...
	<body>
		...
		<!-- Section that explains to user that they can't access the forum unless they are signed in and the log-in button displayed allows users to achieve this -->
		<div class="container-fluid bg-3 text-center">
			<h1 class="margin"><strong>ERROR</strong></h1>
			<h4 style="margin-top: 50px;"><strong>YOU MUST BE A LEGENDS OF AVALON USER TO ACCESS THIS EXCLUSIVE FEATURE!!<br></br> Proceed to sign in to access the FORUM below:</strong></h4>
			<a id="popup-login-download" class="btn btn-default btn-lg" style="margin-top: 50px;">
				<span class="bi bi-lock-fill"></span>Login
			</a>
