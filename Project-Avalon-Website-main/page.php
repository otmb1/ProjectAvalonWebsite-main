...
// if statement that redirects user to the blog page if user is not signed in
...
<html lang="en">
	...
	<body>
		...
		<!-- Section that displays the blog post selected by the user which is possible through the SQL statement below -->
		<div class="container-fluid bg-2 text-center">
			...
			<div class="post-section">
					<?php echo '<img src="data:image;base64,'.base64_encode($row['Image']). '" alt="Image" style="width: 750px; height:auto;" >'; ?>
