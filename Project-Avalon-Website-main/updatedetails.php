...
// if statement that collects the user details inserted by the user and then updates the database based on the details entered by the user
if(isset($_POST['update'])){
	...
	$sql = "UPDATE Users SET Username = '$Username', Email = '$Email', PNumber = '$PNumber' where UUID = '$UUID'";
	...
	if($result)
	{
		...
		<div class="alert-confirm-register">
			<div class="alert alert-success fade in">
				...
				<strong>Success!</strong> You have successfully updated your account! This will take effect in your<strong> next login session!</strong>
			</div>
		</div>
		<?php
    }
...
<html lang="en">
	...
	<body>
		...
		<!-- Section that allows users to update their information -->
		<div class="container-fluid bg-3 text-center">
			<div class="register-form">
				<h1 class="margin"><strong>UPDATE DETAILS</strong></h1>
